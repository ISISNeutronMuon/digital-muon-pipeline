...
use super::partial::FrameDigitiserEventsLists;
...
impl<D> From<FrameDigitiserEventsLists<D>> for AggregatedFrame<D>
where
    DigitiserData<D>: Accumulate<D>,
{
    fn from(mut partial: FrameDigitiserEventsLists<D>) -> Self {
        Self {
            span: partial
                .span_mut()
                .take()
